function LoadingComponent({
    ...
    return (
        <div disabled>
            <h2 class="mt-2 mb-2 text-lg font-semibold text-gray-900 dark:text-white">Finding paths between source and target authors</h2>
            <ul class="max-w-md space-y-2 text-gray-500 list-inside dark:text-gray-400">
                <li class="flex items-center">
                    ...
                    {`Number of authors explored: ${numAuthors}`}
                </li>
                <li class="flex items-center">
                    {isLoading ? 
                    <div role="status">
                    ...
                    {`Number of papers examined: ${numPapers}`}
                </li>
            </ul>
        </div>
    )
