...
function Navbartw() {
  ...
  return (
    <div className="fixed top-0 inset-x-0
        ...
        <div className="w-1/2 h-full mx-auto items-center 
            justify-between gap-2 flex">
            <a className="no-underline text-gray-500 hover:text-black
                dark:text-gray-300 dark:hover:text-gray-100" 
                href="#About">Placeholder 1</a>
            <a className="no-underline text-gray-500 hover:text-black
                dark:text-gray-300 dark:hover:text-gray-100" 
                href="#Education">Placeholder 2</a>
            <a className="no-underline text-gray-500 hover:text-black
                dark:text-gray-300 dark:hover:text-gray-100"  
                href="#Experience">Placeholder 3</a>
            <a className="no-underline text-gray-500 hover:text-black
                dark:text-gray-300 dark:hover:text-gray-100"  
                href="#Projects">Placeholder 4</a>
